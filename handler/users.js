...
contoh :
.register M. RIFQI IRAWAN#200209500003#11 TKJ#SISWA
...
.register M. RIFQI IRAWAN#200206212025031007#-#GURU`,
    ...
    if (role !== "SISWA" && role !== "GURU") {
      return m.reply(
        "Data yang Anda masukkan tidak valid. Untuk `...#PERAN#...`` pilih antara *SISWA* atau *GURU*.",
      );
    } else if (isNaN(regnumber)) {
      return m.reply(
        "Data yang Anda masukkan tidak valid. `...#NIS/NIP#...` harus angka.",
      );
    }
...
exports.member = (m, text, client) => {
  if (isNaN(text) || !text.startsWith("62")) {
